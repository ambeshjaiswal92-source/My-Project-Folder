...
// Keep user-facing sports navigation aligned with sports currently exposed in Admin UI.
export const adminVisibleSportSlugs = [
  'running',
  'football',
  'basketball',
  'cricket',
...
export const userDashboardSportsCategories = adminVisibleSportSlugs
  .map((slug) => sportsCategories.find((sport) => sport.slug === slug))
  .filter(Boolean)
...
export default {
  sportsCategories,
  adminVisibleSportSlugs,
  userDashboardSportsCategories,
  productTypes,
  getSportBySlug,
  getSportById,
